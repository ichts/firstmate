...
FM_SECONDMATE_MELT_COOLDOWN_SECS=3600  # seconds a melt cooldown marker suppresses relaunch for the same live harness/model pair; a restored different pin is not suppressed; invalid values use 3600
